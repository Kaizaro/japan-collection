...
export const ARTICLE_MODALS = [
    ...
    },
    {
        ...
        title: 'Сэппуку',
        text: 'Ритуал самоубийства, дозволенный только классу самураев. Право на самоубийство было большой честью. Приговоренный к казни за преступление самурай, мог не получить право на сэппуку.',
    },
] as IArticleModal[];
