...
export const ARTICLE_MODALS = [
    ...
    // TODO Blade Shortening (maybe article)
    {
        ...
        text: 'Укорачивание клинков большого (основного меча) стало происходить после объединения Японии Токугава Иэясу (ссылка-статья). Полевые сражения в доспехах закончились. И если мечи в оправах «тати» (ссылка-модалка) были немного длиннее, для возможности достать до противника в случае нахождения на лошади, то в наступившую мирную эпоху Эдо в начале XVII века, такая длина меча, обрамленного в оправу «катана» (ссылка-модалка), заткнутого за пояс, стала неудобной в ношении с тканевой одеждой мирного времени. Укорачивание клинков осуществлялось подрезанием хвостовика и перенесением места начала рукояти путём стачивания боковых торцов до нужной точки. (по концу вырезанного дола, и обрезанной подписи, видно, где начинался хвостовик изначально).',
        links: [
            {
